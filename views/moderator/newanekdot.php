...
<main id='main-container' class="main-page-post col-md-9">
	...
	<ul class="nav nav-tabs flat-tabs" role="tablist">
	    <li role="presentation" class="active"><a href="#new" aria-controls="new" role="tab" data-toggle="tab">Новые анекдоты</a></li>
	    ...
	    <div role="tabpanel" class="tab-pane active" id="new">
	    	...
	    	<?php foreach ($newpost as $post): ?>				
					...
					<div class="moder_wrap col-md-6">
						<?= $this->render('templ/_anekdot', [
							'anekdot' => $post,
						]) ?>
						<div class="moder-btn">
						<?= Html::a("Редактировать", Url::to(['moderator/editanekdot', 'id' => $post->id]), ['class' => 'btn btn-primary', 'role' => 'button']) ?>
