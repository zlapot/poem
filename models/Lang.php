...
class Lang extends \yii\base\Model
{
    ...
    public $about=['О нас','About us', 'Despre noi', 'Про нас', 'Информація о насъ', 'استعلامات', 'Мәғлүмәт', 'Über uns', 'L\'information de nous'];
    ...
    public $connect=['Связь','Connect with us', 'Conectare cu noi', 'Зв\'язок', 'Телеграфъ', 'العلاقة', 'Бәйләнеш', 'Verbindung', 'Connectez-vous avec nous'];
